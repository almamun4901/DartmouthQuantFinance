...
export default function Home() {
  return (
    <div className="w-full bg-[#035939] text-[#FAF4E6]">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          {/* Description */}
          <motion.p
            className="text-base sm:text-lg lg:text-xl text-center max-w-4xl mt-4 font-mono px-2"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.6 }}
          >
            Dartmouth Quantitative Finance Club is a group of students who are passionate about technology and trading.
            Join us for problem-solving sessions, mock interviews, social events, and an active community!
          </motion.p>
